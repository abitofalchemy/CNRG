...
def get_grammar_s(original_graph: nx.Graph(),name: str, clustering: str, grammar_type: str, mu: int) -> Tuple[VRG, int]:
    """
    Dump the stats
    :return:
    """
...
### Main 
###
#import sys, os; sys.path.insert(0, os.path.abspath('vrgs'))
from runner import get_grammar, generate_graph

def cnrg_learn_grammars_probabilistic_graph_generation(g, args):
    name, clustering, mode, mu, type, outdir = args.graph, args.clustering, args.boundary, args.mu, \
                                               args.type, args.outdir
